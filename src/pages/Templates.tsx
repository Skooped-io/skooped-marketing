    ...
    <>
        ...
        <div className="relative container mx-auto px-6 text-center max-w-3xl">
          ...
          <ScrollReveal delay={0.15}>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              ...
              your services, your service area. Launch is $500 flat, live in about a week.
            </p>
          </ScrollReveal>
      ...
      <section className="pb-24 px-6 text-center">
        <ScrollReveal>
          ...
          <p className="text-muted-foreground mb-6">We build custom for any local business — Launch is still $500 flat.</p>
          <Link to="/contact">
