...
const Build = () => {
  usePageSeo({
    title: "Build Your Sundae | Skooped — Websites from $500, Plans from $49/mo",
    description:
      "Build your website package like a sundae: pick a cup, add your scoops, throw on toppings, and watch the price add up. Franklin TN — every lead texted to your phone.",
  });
    ...
    <>
      ...
      <section className="relative pt-28 pb-8 overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 max-w-5xl">
          <ScrollReveal>
            <h1 className="text-4xl md:text-[48px] md:leading-tight font-extrabold text-foreground mb-3 text-balance">
              Build your sundae. <span className="text-primary">Watch the price as you stack it.</span>
            </h1>
          </ScrollReveal>
          <ScrollReveal delay={0.15}>
            <p className="text-base text-muted-foreground max-w-2xl leading-relaxed">
              Pick a cup, add your scoops, throw on toppings — the sundae builds itself, scoop by scoop, while you order.
              Same menu as the <Link to="/plans" className="text-primary font-semibold hover:underline">plans page</Link>. No surprises at the register.
            </p>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section className="pb-32 px-6">
        <div className="container mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-[minmax(0,380px)_1fr] gap-8 items-start">
          ...
          <div className="md:sticky md:top-20 rounded-3xl border border-border bg-card p-4 shadow-md">
            ...
            >
              ...
              {/* crown-anchored overlays: sprinkles (below), cherry (on top) */}
              <div
              ...
              >
                <img
                  src={topSprinkles}
                  alt=""
                  className={`w-full origin-top transition-all duration-300 ${tops.sprinkles ? "scale-100 opacity-100" : "scale-50 opacity-0"}`}
                />
              </div>
              <div
                className="pointer-events-none absolute"
              ...
              >
                <img
                  src={topCherry}
                  alt=""
                  className={`w-full origin-bottom transition-all duration-300 ${tops.cherry ? "scale-100 opacity-100" : "scale-50 opacity-0"}`}
                />
              </div>
