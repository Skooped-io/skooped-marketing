...
export const menuItems: Record<string, MenuItem> = {
  ...
  single: {
    ...
    includes: [
      ...
      { label: "30 minutes of edits per month", note: "Text us a change and it joins your queue: edits ship together once a month with your report. Need it this week? Rush any request for a flat $75" },
    ],
    bestFor: [
    ...
    faq: [
      ...
      { q: "How fast do edits happen?", a: "Single edits are batched: we collect your requests and ship them together once a month, timed with your report so you see exactly what changed. Can't wait? A rush edit is a flat $75 per request, or the Double plan includes same-week turnaround on every edit. And if your site is ever down, that's fixed immediately at no charge on any plan." },
  ...
  double: {
    ...
    includes: [
      ...
      { label: "1 hour of edits per month", note: "Bigger changes, new pages, seasonal updates, all with same-week turnaround, no monthly batching (Triple doubles this to 2 hours)" },
    ...
    faq: [
      ...
      { q: "How is Double different from Single?", a: "Single keeps your site alive and texting you leads. Double adds active marketing on top — monthly SEO work, an hour of edits with same-week turnaround (Single edits ship in one monthly batch), and priority response. No meetings to sit through: your monthly report shows the results, and we're a text away whenever you want to talk." },
  ...
  triple: {
    ...
    priceLabel: "$299",
    priceUnit: "/mo",
    tagline: "Everything in Double, plus we run your ads and post for you every week.",
    intro:
      "The Triple scoop is the full marketing team. On top of the Double's SEO work, we run your paid ads on Google and Meta, and we post to your Facebook and Instagram four times a month. Ad spend always bills to your own card: we manage it, we never front it, and we never mark it up. It's the plan for owners ready to put fuel on the fire.",
    ...
    includes: [
      ...
      { label: "Google ads managed", note: "Local Services Ads (the green Google Guaranteed badge) and Search, so you show up both ways buyers look for you" },
      { label: "Meta ads managed", note: "One campaign running across Facebook and Instagram, built and watched for you" },
      { label: "Ad spend on your own card", note: "You pay Google and Meta directly. We never front spend and we never mark it up" },
      { label: "4 posts a month", note: "Four pieces of content, each published to both Facebook and Instagram, written and scheduled for you" },
    ...
    fits:
      "The Triple is the top scoop. It's also the plan the Sprinkles topping rides on: more posts and real video only make sense once Triple's ads are amplifying them. Pay yearly with By the Pint: $2,990/yr, two months free.",
    faq: [
      { q: "Do you take a cut of my ad spend?", a: "Never. Ad spend bills directly to your own card, so you see every dollar Google and Meta charge. We charge only for managing the campaigns. No markup, no fronting spend." },
      { q: "Which ads do you actually run?", a: "Two platforms. On Google that's Local Services Ads, the unit at the very top with the green Google Guaranteed check, plus Search, which is the Sponsored result people see when they type what they need. On Meta it's one campaign that runs across both Facebook and Instagram. Which ones we start with depends on your trade and your market, and we tell you why." },
      { q: "What's in the monthly report, and how do I get it?", a: REPORT_BASE + " On the Triple plan it also breaks down your ad performance: what you spent on each platform and the leads those campaigns brought in." },
      { q: "What's the difference between Triple and Sprinkles?", a: "Triple ($299/mo) runs your ads and posts 4 times a month. Sprinkles (+$350/mo) takes those 4 posts to 12, edits and curates them, and puts real video in the mix instead of stills only. Sprinkles rides on top of Triple." },
    ...
    cta: { label: "Start on the Triple plan: $299/mo", message: "Hey Skooped, I want the Triple plan ($299/mo) with ads management and 4 posts a month. Let's talk." },
    ...
    seo: {
      title: "Triple Plan: $299/mo Google & Meta Ads Management | Skooped Franklin TN",
      description:
        "The Triple scoop: $299/mo adds Google ads (Local Services and Search), Meta ads across Facebook and Instagram, and 4 posts a month to everything in Double. Ad spend stays on your card, never marked up. Full-service local marketing in Franklin, TN.",
    },
  },
  ...
  "local-scoop": {
    ...
    faq: [
      ...
      { q: "I have a Skooped website already. Can I buy this?", a: "You can, but check the math first. If you are on the Single plan at $49, adding this puts you at $149, which is exactly what the Double Scoop costs, and the Double includes everything here plus ongoing local SEO, an hour of same-week edits, and priority response. Same money, more work done. We will point you to the Double every time." },
    ],
    related: ["double", "cup"],
  ...
  sprinkles: {
    ...
    category: "topping",
    name: "Sprinkles",
    subtitle: "Triple the posts, edited and curated: +$350/mo",
    hero: topSprinkles,
    priceLabel: "+$350",
    priceUnit: "/mo",
    tagline: "Your 4 posts a month become 12, with real video in the mix.",
    intro:
      "Sprinkles is the content engine. Triple posts for you 4 times a month. Sprinkles takes that to 12, cut and captioned from the photos and clips you and your crew send in, with at least 4 of them real video instead of stills. You send what happens on the job. We turn it into a month of content that actually looks like your work. Availability is limited, and Sprinkles rides on the Triple plan, where the ads amplify everything you send.",
    includesHeading: "What +$350/mo adds",
    includes: [
      { label: "12 posts a month instead of 4", note: "Three times the output, each one published across Facebook and Instagram" },
      { label: "At least 4 real videos", note: "Actual footage cut into something worth watching, not a slow zoom on a photo" },
      { label: "Curated and edited for you", note: "You send raw photos and clips from the job. We pick, cut, caption, and schedule" },
      { label: "We come out when you want us", note: "Ask and we're there, no extra charge. For a job that deserves a full production we'll bring in a pro and quote it separately" },
      { label: "Rides on the Triple plan", note: "The ads in Triple put every post to work instead of letting it sit" },
    ],
    bestFor: [
    ...
    fits:
      "Sprinkles is a topping that only goes on the Triple scoop, which is why picking it in the builder bumps you up to Triple. Limited availability: we only take on as many content clients as we can serve well.",
    faq: [
      { q: "Why does Sprinkles require the Triple plan?", a: "Content works best when something amplifies it. Triple's ad management is what turns your photos and videos into leads, so tripling your posts only makes sense once that engine is running. That's why Sprinkles rides on Triple." },
      { q: "Where does the content come from?", a: "From your work. You and your crew send photos and short clips straight from the job, and we handle everything after that: picking the good ones, editing, writing the caption, and scheduling. If you want us on site, say the word and we'll come out at no extra charge. For a job that deserves a full production with a professional videographer, we'll arrange it and quote that shoot separately." },
      { q: "What if we're slammed and forget to send anything?", a: "Light months happen. We work from what's already in your library and we tell you straight in the monthly report what went out. The more you send, the better the month looks, and it takes about thirty seconds on your phone." },
      { q: "Is it real photos, or stock?", a: "Real, always. Your jobs, your crew, your trucks. We do not post stock photography and we do not post AI-generated images of work that never happened." },
      { q: "Is availability really limited?", a: "Yes. Editing and curation is real time, so we cap how many businesses we take on to keep the quality high. If we're at capacity, we'll tell you straight and hold your spot." },
    ],
    related: ["triple", "double", "cherry-on-top"],
    cta: { label: "Add Sprinkles: +$350/mo on Triple", message: "Hey Skooped, I want to add Sprinkles (12 posts a month instead of 4, +$350/mo) on the Triple plan. Is there availability?" },
    offer: { kind: "recurring", price: 350, unit: "MONTH" },
    seo: {
      title: "Sprinkles: 12 Social Posts a Month With Real Video, +$350/mo | Skooped",
      description:
        "Sprinkles takes Triple's 4 posts a month to 12, edited and curated from your own job photos and clips, with at least 4 real videos. +$350/mo on the Triple plan. Limited availability. Franklin, TN.",
    },
  },
